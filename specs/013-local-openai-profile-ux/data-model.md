...
- `actionId`：对应 Translate、Save Languages、Save/Update/Credential、Select、Test、Delete 或 Retry 控件。
...
源码 manifest、npm 两处根版本、pack 安全路径、当前版本发布正文、staging 和最终归档必须一致。历史 0.3.3 更新说明与验收证据不是当前身份字段，不随版本替换。
