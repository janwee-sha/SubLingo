...
当前仓库在公开发布前至少需要完成以下事项：

- 添加明确的开源许可证；“免费使用”不能替代软件许可证；
...
许可证选择会决定用户的再分发和修改权，应由维护者在发布前明确决定。若目标是鼓励社区使用和贡献，可优先评估 MIT 或 Apache-2.0；
若不准备开放再分发与修改权，则需要制定与“源码公开”不同的授权方式，不能默认套用开源表述。

## 推荐上线顺序

1. 确定许可证、维护者身份和公开联系方式；
