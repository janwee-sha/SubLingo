...
The user installed this archive through IINA's normal package flow. IINA reported SubLingo 0.1.4, the installed package path was a normal directory rather than a development symlink, and the Uninstall button was enabled. Installed SHA-256 values matched the staged build:
