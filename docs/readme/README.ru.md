...
Начиная с SubLingo 0.3.3, IINA может проверять и устанавливать последующие версии. Версии 0.3.2 и более ранние не содержат метаданных обновления, поэтому один раз обновитесь вручную до 0.3.3, установив плагин из GitHub или загруженного пакета.
