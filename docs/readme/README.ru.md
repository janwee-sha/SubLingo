...
2. Откройте загруженный пакет с помощью IINA и подтвердите запрошенные разрешения плагина.
3. Перезапустите IINA, откройте **Settings → Plugins** и убедитесь, что SubLingo включён.
4. Запустите видео, откройте боковую панель IINA и выберите вкладку **SubLingo**.
