...
SubLingo переводит встроенные текстовые субтитры локального видео или внешний SRT/ASS, выбранный в [IINA](https://iina.io/), и показывает перевод как вторую дорожку. Плагин обрабатывает только небольшой участок рядом с текущей позицией ограниченными пакетами; при задержке или ошибке видео и оригинал продолжают воспроизводиться.
